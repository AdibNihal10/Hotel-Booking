...
class Vehicles implements Serializable
{
    ...
    Vehicles(int itemno,int quantity)
    {
        this.itemno=itemno;
        ...
        System.out.println ("Vehicle booking successful");
    }
}
...
class Hotel
{
    ...
    {
        double amount=0;
        String list[]={"Perdana","Porche","Lambo","JDM"};
        System.out.println("\n***");
        ...
        switch(rtype)
        {
            case 1:
                amount+=4000;
                    System.out.println("\nRoom Charge - "+4000);
                    System.out.println("\n===============");
                    System.out.println("Vehicles Charges:- ");
                    System.out.println("===============");
                     System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Vehicles obb:hotel_ob.luxury_doublerrom[rn].Vehicles)
                    {
                        amount+=obb.price;
            ...
            case 2:amount+=3000;
                    ...
                    System.out.println("===============");
                     System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Vehicles obb:hotel_ob.deluxe_doublerrom[rn].Vehicles)
                    {
                        amount+=obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
            ...
            case 3:amount+=2200;
                    ...
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Vehicles obb:hotel_ob.luxury_singleerrom[rn].Vehicles)
                    {
                        amount+=obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
            ...
            case 4:amount+=1200;
                    ...
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Vehicles obb: hotel_ob.deluxe_singleerrom[rn].Vehicles)
                    {
                        amount+=obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
    ...
    static void order(int rn,int rtype)
    {
        ...
        do
        {
            ...
            q=sc.nextInt();
              ...
              switch(rtype){
            case 1: hotel_ob.luxury_doublerrom[rn].Vehicles.add(new Vehicles(i,q));
                break;
            case 2: hotel_ob.deluxe_doublerrom[rn].Vehicles.add(new Vehicles(i,q));
                break;
            case 3: hotel_ob.luxury_singleerrom[rn].Vehicles.add(new Vehicles(i,q));
                break;
            case 4: hotel_ob.deluxe_singleerrom[rn].Vehicles.add(new Vehicles(i,q));
                break;                                                 
        }
